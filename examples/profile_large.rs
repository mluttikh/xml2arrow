...
"#,
    ...
    eprintln!("Generating XML (100K measurements x 10 sensors)...");
    let xml = generate_xml(100_000, 10);
    eprintln!("XML size: {} MB", xml.len() / (1024 * 1024));
